...
<body style='background:url(adminn.jpg)'>
    <div class='sidenav' id='visible'>
    <img src='images/logo.png' class='logo'>
        <br><br><br><br><br>
        <button  id='create' onclick='create()'>A-Add hotel  <i class='fas fa-plus-circle'></i></button><br>
        <button  id='edit' onclick=edit()>A-Edit hotel  <i class='fas fa-edit'></i></button><br>
        <button  id='view' onclick=view()>A-View DB <i class='fas fa-eye'></i></button><br>
    ...
    <center><h1> DO WONDERS WITH THE PRIVILEGES YOU DESERVE</h1></center><a class='switch' href='major.php' style='float:right' >BACK</a>
...
if(isset($_GET['hotel'])){
    ...
    if( $result !== FALSE){
      if ($result->num_rows > 0) {
        echo "<center><table style='width:600px;height:40%;>
...
<body style='background:url(adminn.jpg)'>
    ...
    <center><h1> DO WONDERS WITH THE PRIVILEGES YOU DESERVE</h1></center>
    <div class='main' id ='box1' style='display:none;'>
